...
var TodoService = function () { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, _a, data, error;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, supabase_1.getSupabase()];
            case 1:
                supabase = _b.sent();
            ...
            case 2:
                ...
                //console.log(data);
                return [2 /*return*/, react_1["default"].createElement("div", null, JSON.stringify(data))];
